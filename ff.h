...
enum
{
	E_APP = -1, E_DEB = 0, E_TIMEOUT, E_FTPGETFILE, E_FTPREPLY, E_FTPCMD, E_TIMEOUTCHANGE, E_SERVERBANNER, E_EXCEPTION,
	...
	E_CACHEFREED, E_CACHEMSG, E_FTPCONTROL, E_FTPREADINGLINE, E_FTPREADLINE, E_SECOND = 43, E_UNLOCKING, E_UNLOCKED,
	E_LOCKING, E_LOCKED, E_DEVMSG = 48
};

#define call_events(...) _call_events(__FUNC__,__LINE__,__VA_ARGS__)

void _call_events(char*func, int line, int type, LPVOID arg = NULL, LPVOID arg2 = NULL, LPVOID arg3 = NULL,
	LPVOID arg4 = NULL, LPVOID arg5 = NULL, LPVOID arg6 = NULL, LPVOID arg7 = NULL, LPVOID arg8 = NULL);

typedef LPVOID(WINAPI * call_func)(int type, LARGE_INTEGER numevent, LPVOID arg, LPVOID arg2, LPVOID arg3, LPVOID arg4, LPVOID arg5,
